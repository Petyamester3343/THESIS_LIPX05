...
namespace Y0KAI_BnB
{
    internal class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            if (string.IsNullOrWhiteSpace(outPath)) outPath = "BranchAndBound_Solution.txt";
            ...
            try
            {
                ...
                output.WriteLine("# Simulated Annealing Solution (Generated by Y0KAI_BnB)\n# NODES:");
